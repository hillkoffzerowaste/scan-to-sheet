...
สิทธิ์งานปฏิบัติการต้องมี Firebase custom claim `operator: true` เพิ่มเติมจากการ login ด้วย Google เพื่อกันบัญชี Google ทั่วไปเข้าถึงออเดอร์หรือวิดีโอแพ็ค ให้ผู้ดูแลที่ใช้ Firebase Admin SDK ตั้ง claim สำหรับพนักงานแต่ละ UID แล้วให้พนักงานออกและเข้าสู่ระบบใหม่เพื่อรับ token ใหม่:
