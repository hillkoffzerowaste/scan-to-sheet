# DESIGN.md — Hillkoff Enterprise × Flip7
...
### แบรนด์ teal (Hillkoff เดิม ไม่เปลี่ยน)

| Token | Light | Dark | หมายเหตุ |
|---|---|---|---|
| `--primary` | `#04817d` | `#1aa39d` | teal สำหรับ text/border — เลื่อนจาก `#058581` เพราะของเดิมวัดได้ **4.489** ตกเกณฑ์ ทำให้ปุ่มหลักทุกปุ่มตกพร้อมกัน |
| `--primary-strong` | `#046662` | `#51ddd7` | เน้นกว่า |
| `--primary-fill` | `#04817d` | `#0f6f6a` | **พื้นที่มีตัวขาวทับ** แยกจาก `--primary` เพราะใน dark mode `--primary` ต้องสว่างพอจะอ่านเป็น *ตัวหนังสือ* บนพื้นเข้ม ซึ่งสว่างเกินกว่าจะเอาตัวขาวมาทับ |
| `--topbar-bg` | `#046662` | `#0a2e2c` | เข้มทั้งสองธีม เพื่อให้ตัวขาวและ pill ของ theme toggle อ่านได้ |
